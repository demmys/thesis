...
3. ソースコード可読性の向上方法と評価手法 :readability
    ...
    2. ソースコード可読性の評価手法 :evaluation
        ...
        * ソフトウェアの複雑性についてはよく知られた3種類の手法がある (http://www3.nd.edu/~rsanteli/pate-sp12/readings/SurveyComplexity.pdf)
        * 各評価手法の概要とその特徴
            1. Line of Code (LOC)
            ...
            2. Halstead Complexity Metrics (HCM)
                ...
                * 使用されているプログラミング言語によって演算子と被演算子の区別を行う必要がある //TODO実例
        ...
        * また、コメントの記述量を評価する手法としては //TODO手法を載せる
        * テストの記述量を評価する手法としてはコードカバレッジの計測などがある
    3. 本研究のアプローチ :idea
        ...
        * 他のコンパイラでよく行われている手法としてコンパイラを自分自身で書き直すSelf-host化がある
        ...
        * Self-host化したSwiftコンパイラを実装し、:readability:evaluationで述べたいずれかの手法でそのコンパイラの複雑性を現行のコンパイラと比較することでアプローチの正当性を示す
4. Self-host化による副作用
    1. Self-host化の事例
        1. Go - go
        2. Python - PyPy
