...
pdftitle={Improvement of the Readability of Swift Compiler's Source Code by Self-hosting},%
%%pdfsubject={},%
...
\input{src/2_open-source}
\input{src/3_readability}
\input{src/4_side-effect}
\input{src/5_refinement}
...
\input{bib/biblio}\thispagestyle{empty}%bibtex
